...
CREATE TABLE `page` (
  `NM_page` int(10) UNSIGNED NOT NULL,
  'ID_post ` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
ALTER TABLE  ` page `
  ADD PRIMARY KEY (`NM_page`),
  ADD KEY ` LINK ` (` ID_post `) USING BTREE;
...
--
ALTER TABLE ` page `
  MODIFY  `NM_page` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
